...
<head>
  ...
  <title><?php echo $sitename ?> - Amin</title>
...
<body>
                    ...
                    <?php
                        ...
                        <tr>
                          ...
                          <td><?php
                                          ...
                                          }else if($details['status'] == 'success' || $details['status'] == 'approved' || $details['status'] == 'completed') {
  ...
  <?php
      if (isset($_GET['del_id']) && !isset($_GET['reason']) ) {
        ...
        if (reason) {
            window.location.href = 'book.php?del_id=$del_id&reason=' + encodeURIComponent(reason);
        }
    </script>";
      }
