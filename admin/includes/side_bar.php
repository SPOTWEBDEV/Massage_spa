<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1 mt-5">
        ...
        <li class="menu-item active">
            <a href="<?php echo $domain ?>admin/index.php" class="menu-link">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="<?php echo $domain ?>admin/book.php" class="menu-link">
                        <div data-i18n="Without menu">All Booking</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="<?php echo $domain ?>admin/booking/pending/" class="menu-link">
                        <div data-i18n="Without menu">Pending Booking</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="<?php echo $domain ?>admin/booking/completed/" class="menu-link">
        ...
        <li class="menu-item">
            <a href="<?php echo $domain ?>admin/pricing.php" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Add message Pricing</div>
            </a>
        </li>
        ...
        <li class="menu-item">
            <a href="<?php echo $domain ?>admin/pricing_list.php" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">message Pricing List</div>
            </a>
        </li>

        
        <li class="menu-item">
            <a href="<?php echo $domain ?>admin/contact.php" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
