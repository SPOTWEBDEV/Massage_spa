        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <h4 class="fw-bold py-3 mb-4">
              <span class="text-muted fw-light">Admin /</span>Completed Booking
            </h4>

            <!-- Basic Bootstrap Table -->
            <div class="card">
              <h5 class="card-header">All Completed Booking</h5>
                ...
                <table class="table">
                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    <?php $count++;
                      ...
                      echo "<td class='bg-danger text-white' colspan='10'>No Completed Booking Found</td>";
                    } ?>
                  </tbody>
                </table>
              </div>
