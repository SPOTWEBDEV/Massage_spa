                            ...
                            <div class="table-responsive text-nowrap">
                                <table class="table">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        $sql = mysqli_query($connection, "SELECT booking.*,user.fullname,user.email,user.phone FROM booking,user WHERE booking.status ='declined' and booking.user=user.id");
