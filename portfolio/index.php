        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="member-winning-awards">
                        <!-- Winning Awards Content Start -->
                        <div class="winning-awards-content">
                            <h2 class="wow fadeInUp">Awards & Honor</h2>
                        ...
                        <div class="winning-awards-box">
                            <div class="row">
                                <div class="col-6">
                                    <div class="winning-award-img img-box-1">
                                        <img src="<?php echo $domain ?>assets/images/icon-award-1.svg" alt="">
                                    </div>
                                </div>

                                <div class="col-6">
                                    <div class="winning-award-img img-box-2">
                                        <img src="<?php echo $domain ?>assets/images/icon-award-2.svg" alt="">
                                    </div>
                                </div>

                                <div class="col-6">
                                    <div class="winning-award-img img-box-3">
                                        <img src="<?php echo $domain ?>assets/images/icon-award-3.svg" alt="">
                                    </div>
                                </div>

                                <div class="col-6">
                                    <div class="winning-award-img img-box-4">
                                        <img src="<?php echo $domain ?>assets/images/icon-award-4.svg" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="cta-infobar team-sidebar-cta wow fadeInUp" data-wow-delay="0.25s">
