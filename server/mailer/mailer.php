...
function smtpmailer($to, $from, $from_name, $subject, $body) {
    ...
    $mail->Host = 'mail.bodyandsoulrelax.com';
    $mail->Port = 465; // Or 587 if using 'tls'
    $mail->Username = 'support@bodyandsoulrelax.com';
    $mail->Password = 'support@bodyandsoulrelax.com'; // Use your actual email password
